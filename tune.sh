...
run_model() {
    ...
    nohup python main.py --candidate --tau $param --modeltype INFONCE --dataset yahoo.new --n_layers 2 --batch_size 2048 --lr 5e-4 --neg_sample 128 --infonce 1 --saveID eval_tau &> logs/0704_test_CF_Rec.log &
}
